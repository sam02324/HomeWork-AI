...
| GAI-007 | P0 | Production configuration and fresh-user launch drill | Rowan - DevOps and SRE | Quinn, Sana, Arjun, Nora | Owner gate | Rotated historical secrets, verified providers, non-admin end-to-end journey, live commit and rollback evidence |
